    ...
    <>
      ...
      <section className="events">
        ...
        <div className="row">
          <div className="col">
            ...
            <p>
              Learn Acoustic or electric guitar by an experienced instructor and
              learn to play today. It's never to late to learn. All ages.
              ukulele lessons.
            </p>
            <br />
          ...
          <div className="col">
            ...
            <p>
              Come vibe with us at our Open Mic night. Share your talents in
              front of a live audience through song, poetry or rap!
            </p>
            <br />
            <a href="/aboutus" className="btn">
              {" "}
      ...
      <section className="explore">
        <div className="explore-content">
          ...
          <div className="line"></div>
          <p>
            x100pre Records has partnered with Apple Music. Free 1 month trial
            to get a feel for your sound. Enjoy a variety of music, artists,
            playlists and more!
          </p>
          <a href="https://www.apple.com/apple-music/" className="btn">
            {" "}
            Learn More
          </a>
        </div>
      ...
      <section className="records">
        <div className="row">
          <div className="col content-col">
            ...
            <div className="line"></div>
            <p>
              Check out some of the top sellers from this month! And don't
              forget to check out the new vinyls that recently have been
              released.
            </p>
            <a href="/products" className="btn">
              {" "}
