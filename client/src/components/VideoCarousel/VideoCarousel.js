...
const VideoCarousel = () => {
  return (
    ...
    >
      <div className="video">
        <video src={BadBunny} autoPlay={true} preLoad="auto" loop muted></video>
      </div>

      <div className="video">
        <video src={SZA} autoPlay={true} preLoad="auto" loop muted></video>
      </div>

      <div className="video">
        <video autoPlay={true} preLoad="auto" loop muted src={SELENA}></video>
      </div>

      <div className="video">
        <video src={HARRY} autoPlay={true} preLoad="auto" loop muted></video>
      </div>
    </Carousel>
  );
};
